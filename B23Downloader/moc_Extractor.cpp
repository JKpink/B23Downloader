...
void Extractor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Extractor::*)(const QString & )>(_a, &Extractor::errorOccurred, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (Extractor::*)()>(_a, &Extractor::success, 1))
            return;
    }
}

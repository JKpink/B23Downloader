...
template <> constexpr inline auto LoginDialog::qt_create_metaobjectdata<qt_meta_tag_ZN11LoginDialogE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        ...
        "",
        "pollLoginInfo",
        "getLoginInfoFinished"
    };

    QtMocHelpers::UintData qt_methods {
        // Slot 'getLoginUrlFinished'
        QtMocHelpers::SlotData<void()>(1, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'pollLoginInfo'
        QtMocHelpers::SlotData<void()>(3, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'getLoginInfoFinished'
...
void LoginDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->getLoginUrlFinished(); break;
        case 1: _t->pollLoginInfo(); break;
        case 2: _t->getLoginInfoFinished(); break;
        default: ;
        }
    }
    (void)_a;
